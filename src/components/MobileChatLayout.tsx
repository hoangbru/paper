  ...
  return (
    <div className='fixed z-50 bg-zinc-50 border-b border-zinc-200 top-0 inset-x-0 py-2 px-4'>
      <div className='w-full flex justify-between items-center'>
        ...
        <Button variant='ghost' onClick={() => setOpen(true)} className='gap-4'>
                          ...
                          <ul
                                ...
                                {sidebarOptions.map((option) => {
                                  ...
                                  return (
                                    <li key={option.name}>
                                      <Link
                                        href={option.href}
                                        className='text-gray-700 hover:text-gray-600 hover:bg-gray-50 group flex gap-x-3 rounded-md p-2 text-sm leading-6 font-semibold'>
                            ...
                            <li className='-ml-6 mt-auto flex items-center'>
                              <div className='flex flex-1 items-center gap-x-4 px-6 py-3 text-sm font-semibold leading-6 text-gray-900'>
                                ...
                                <span className='sr-only'>Hồ sơ của bạn</span>
