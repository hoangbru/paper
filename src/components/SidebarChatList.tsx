...
import { chatHrefContructor, toPusherKey } from "@/libs/utils";
        ...
        return (
          <li key={friend.id}>
            <a
              ...
              className="text-gray-700 hover:bg-gray-200 group flex items-center gap-x-3 rounded-md p-2 text-sm leading-6 font-semibold"
            >
              <Image
                src={friend.image}
                width={40}
